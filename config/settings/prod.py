...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS") #, default=["app.stratalerts.com", "24.144.96.77"])
# https://docs.djangoproject.com/en/4.2/ref/settings/#csrf-trusted-origins
CSRF_TRUSTED_ORIGINS = ['https://app.stratalerts.com']
# https://www.stackhawk.com/blog/django-cors-guide/#cors_allowed_origins
CORS_ALLOWED_ORIGINS = [
   "https://app.stratalerts.com",
]
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="STAT Trading <help@stratalerts.com>",
)
