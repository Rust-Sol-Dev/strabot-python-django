...
PRODUCTION_DOTENVS_DIR_PATH = ROOT_DIR_PATH / ".envs" / ".prod"
PRODUCTION_DOTENV_FILE_PATHS = [
    PRODUCTION_DOTENVS_DIR_PATH / ".django.env",
    PRODUCTION_DOTENVS_DIR_PATH / ".postgres.env",
    PRODUCTION_DOTENVS_DIR_PATH / ".redis.env",
    PRODUCTION_DOTENVS_DIR_PATH / ".redpanda.env",
    PRODUCTION_DOTENVS_DIR_PATH / ".celery.env",
    PRODUCTION_DOTENVS_DIR_PATH / ".secrets.env",
    PRODUCTION_DOTENVS_DIR_PATH / ".specific.env",
]
